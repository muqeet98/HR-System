...
import { StyleSheet, Text, View, ScrollView, FlatList, Picker, Image, TouchableOpacity, Button,ImageBackground, Alert } from 'react-native';
...
class UpdateEmployeeHod extends React.Component {
  constructor(props) {
    super(props);
 ...
 <ImageBackground source={{ uri: 'data:image/jpeg;base64,' + this.state.dp }}  style={{ width: 130, height: 130, alignItems: 'center', justifyContent: 'center', marginBottom: '5%' }}>
          ...
          <TextInput style={styles.textInputstyle}
            ...
            onChangeText={name => this.setState({ name }, console.log(this.state.name))}
          />
          <TextInput style={styles.textInputstyle}
            label='CNIC'
            mode='outlined'
          ...
          <View style={{ flexDirection: 'row', marginTop: ('7%'), fontSize: 30 }}>
           ...
           // defaultValue={designation} 
              onValueChange={position => {
                this.setState({designation: position })
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity style={styles.signupbutton} onPress={() => this.props.navigation.navigate("HodAllEmployee")}>
...
export default UpdateEmployeeHod;
