...
import Holiday from './AdminScr/AdmHoliday';
import HolidayView from './EmployeeScr/ViewHolidays'

import HodLogin from './HodScr/HodLigin';
import HodHome from './HodScr/HodHome';
import HodAllEmployee from './HodScr/HodAllEmployee';
import HodEmployeeDetail from './HodScr/HodEmpDetail';
import UpdateEmployeeHod from './HodScr/UpdateEmployeeHod'
...
<Stack.Screen name="AdmHoliday" component={Holiday} options={{
...
<Stack.Screen name="Holiday" component={HolidayView} options={{
          title: 'Public Holidays',
          headerStyle: {
            backgroundColor: '#E66E2F'
          },
...
<Stack.Screen name="HodLogin" component={HodLogin}
         options={{
          title: 'Hod Login',
          headerStyle: {
            backgroundColor: '#E66E2F',
...
<Stack.Screen name="HodHome" component={HodHome}
           options={({ navigation }) => ({
             headerShown: false,
            title: 'Hod Home',
            headerStyle: {
...
<Stack.Screen name="HodAllEmployees" component={HodAllEmployee}
         options={{
          title: 'All Employees H',
          headerStyle: {
            backgroundColor: '#E66E2F',
          },
        ...
        <Stack.Screen name="HodEmployeeDetail" component={HodEmployeeDetail}
         options={{
          title: 'Employees Details H',
          headerStyle: {
            backgroundColor: '#E66E2F',
          },
        ...
        <Stack.Screen name="UpdateEmployeeHod" component={UpdateEmployeeHod}
         options={{
