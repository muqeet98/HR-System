...
const HolidayView = (props) => {
  ...
  const PostData = () => {
    ...
    fetch('http://'+ global.IP +'/BIIT_HR/api/criteria/getHoliday?h_id=2', {
      })
        .then(res => res.json())
        .then(data => {
          console.log(data)
            totalleaves(data[0].hajj)
    ...
    return (
        ...
        <KeyboardAvoidingView behavior="height" style={styles.container}>
            <TouchableWithoutFeedback style={styles.container} onPress={Keyboard.dismiss}>
                ...
                <View>
                        <Text style={{ fontSize: 25, fontStyle: 'normal', marginLeft: ('30%'), fontWeight: "bold" }}>Leave Criteria </Text>
                    </View>
