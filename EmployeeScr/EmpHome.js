...
const EmpHome = (props) => {
 ...
 const [designation, Designation] = useState("");
 const [contact_no, Contact_no] = useState("");
...
const toggleModal =(visible) => {
 ...
 onPress={() => props.navigation.navigate("Notification",{emp_id: emp_id})} />
        ...
        <View style={{flexDirection:'row', marginTop: hp('15%'), marginLeft: ('15%')}}>
...
<Text style={styles.cardText}>Employee Management</Text>
          ...
          {/* <View style={styles.cardcover} >
            <Card onPress={() => props.navigation.navigate("Holiday", {emp_id: emp_id})} style={styles.cardcover}>
              <Card.Cover source={require('../icons/attendance.png')} style={styles.cardimage} />
              <Text style={styles.cardText}>Public Holidays</Text>
            </Card>
