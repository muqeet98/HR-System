...
class LeaveReq extends React.Component {
  ...
  RemainLeave = () => {
   ...
   PostData = async () => {
    ...
    // });
    //alert(this.state.day_from)
alert("Hello day", this.state.day_from)
  ...
  const { emp_id } = this.props.route.params;
    ...
    <Text style={styles.buttonText2}>View Remaining Leaves {emp_id}</Text>
            ...
            <Picker
              ...
              style={{ height: 40, width: wp('40%'), color: 'black', marginLeft: ('15%'), fontSize: 20 }}
              mode='dropdown'
            >
...
<View>
<Picker
              onValueChange={day_from => {
                this.setState({ day_from })
                console.log('changed to', day_from)
              }}
              selectedValue={this.state.day_from}
              style={{ height: 40, width: wp('50%'), color: 'black', marginLeft: ('40%'), fontSize: 20 }}
              mode='dropdown'
            >
              <Picker.Item label="Select Day From" value="Day1" />
...
<View>
<Picker
              onValueChange={day_to => {
                this.setState({ day_to })
                console.log('changed to', day_to)
              }}
              selectedValue={this.state.day_to}
              style={{ height: 40, width: wp('50%'), color: 'black', marginLeft: ('40%'), fontSize: 20 , borderColor:'black', borderWidth:2 }}
              mode='dropdown'
            >
              <Picker.Item label="Select Day To" value="Day2" />
              <Picker.Item label="Monday" value="Monday" />
              <Picker.Item label="Tuesday" value="Tuesday" />
              <Picker.Item label="Wednesday" value="Wednesday" />
              <Picker.Item label="Thursday" value="Thursday" />
              ...
              <View>
                <Text style={styles.textstyle, { marginTop: 10, color: 'white', fontSize: 20, marginLeft: 20 }}>Details</Text>
                <TextInput
                  multiline={true}
                  numberOfLines={8}
